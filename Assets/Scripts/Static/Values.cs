...
public static class Values
{
    ...
    public const float START_WATER_HEIGHT = .7f;
    public const int START_YEAR = 2017;
    public const int PLAY_YEARS = 333;
    ...
    public const float FACTORY_GENERATION_CHANCE = 0.2f;
    ...
    public const float SECONDS_PER_YEAR = .5f;

    public const float CARBON_LOWER_LIMIT = 150f;
    public const float WATER_LOWER_LIMIT = .1f;

    public const float METER_TO_REAL_METER = 1f;
}
